...
bool SettingScene::init()
{
    ...
    auto label = Label::createWithTTF("Pocket Astrophysics Settings", "fonts/Marker Felt.ttf", 30);
    if (label == nullptr)
    {
...
void SettingScene::menuCloseCallback(Ref* pSender)
{
    ...
    //Director::getInstance()->replaceScene(TransitionFade::create(3.0f, BasicScene::create()));
